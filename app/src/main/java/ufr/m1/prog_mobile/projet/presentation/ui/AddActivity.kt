            ...
            ProjetTheme {
                Scaffold(
                    modifier = Modifier.fillMaxSize()){
                        innerPadding ->
                    MyAddActScreen(modifier = Modifier.padding(innerPadding), model)
                }
            }
        }
    }
...
@Composable
fun MyAddActScreen(modifier: Modifier, model: AddActViewModel) {
    Column (
        modifier = modifier
            .padding(16.dp)
            .fillMaxHeight(),
...
@Composable
fun DelaySelection(model: AddActViewModel){
...
//@Composable
//fun TimerButton(model: AddActViewModel){
...
//@SuppressLint("StateFlowValueCalledInComposition")
//@Composable
//fun SelectionAnimal(nom: String, model: AddActViewModel) {
//
//    OutlinedTextField(
//        value = nom,
//        onValueChange = {},
...
@Composable
fun BackToInfoButton(model: AddActViewModel){
    val context = LocalContext.current
    Row (
        horizontalArrangement = Arrangement.SpaceBetween,
        modifier = Modifier.fillMaxWidth()
        ...
        IconButton(
            onClick = {
                ...
                iii.putExtra("id", model.currentAnimal.value.id.toString())
